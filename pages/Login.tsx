...
export const Login = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
        ...
        alert('Chyba přihlášení. Zkontrolujte nastavení Supabase Auth.');
        setLoading(false);
    }
  };
      ...
      <Card className="w-full max-w-md border-border/60 shadow-xl">
          <CardContent className="pt-8 pb-8 px-8 space-y-6">
              <div className="text-center">
                  <h3 className="text-lg font-medium">Přihlášení</h3>
                  <p className="text-sm text-muted-foreground">Pouze pro zaměstnance @skolapopulo.cz</p>
              </div>
              ...
              >
                 ...
                 {loading ? 'Připojování...' : 'Pokračovat přes Google Workspace'}
              </Button>
